...
export const aboutMe = {
  ...
  githubUsername: "mittal-parth", // Keep existing for now, can be updated later
  tagLine: "Global Development Partners | 50+ Successful Projects | Multi-National Team | Enterprise Solutions",
  intro: "We are a global development agency turning bold ideas into outstanding digital experiences.",
  weWant_1: "Our success is built on strong partnerships with ",
  weWant_2: " and we’re always eager to collaborate with more exceptional teams and individuals around the world."
};
